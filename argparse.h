...
#define ARGPARSE_BOOL(SH,LN,A,DESC)  {ARGPARSE_T_BOOL, SH,  "--"#LN, A,    NULL, DESC}
#define ARGPARSE_STR(SH,LN,A,V,DESC) {ARGPARSE_T_STR,  SH,  "--"#LN, A,    V,    DESC}
#define ARGPARSE_DEF(SH,LN,A,V,DESC) {ARGPARSE_T_DEF,  SH,  "--"#LN, A,    V,    DESC}
#define ARGPARSE_END()               {ARGPARSE_T_END,  '-', NULL,    NULL, NULL, NULL}

#define ARGPARSE_ERROR(S,B) { fprintf(stderr,S,B); }

#define ARGPARSE_MAX_ARG 64
